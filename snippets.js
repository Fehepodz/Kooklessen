const SNIPPETS = [
  {
    id: 'ui-snipperen', categorie: 'Snijden', emoji: '🧅',
    naam: 'Ui snipperen',
  ...
  {
    id: 'knoflook-hakken', categorie: 'Snijden', emoji: '🧄',
  ...
  {
    id: 'julienne', categorie: 'Snijden', emoji: '🥕',
  ...
  {
    id: 'brunoise', categorie: 'Snijden', emoji: '🎲',
  ...
  {
    id: 'mes-vasthouden', categorie: 'Snijden', emoji: '🔪',
    naam: 'Mes vasthouden',
  ...
  {
    id: 'water-koken', categorie: 'Koken', emoji: '💧',
  ...
  {
    id: 'pasta-koken', categorie: 'Koken', emoji: '🍝',
    naam: 'Pasta koken',
  ...
  {
    id: 'eieren-koken', categorie: 'Koken', emoji: '🥚',
    naam: 'Eieren koken',
  ...
  {
    id: 'blancheren', categorie: 'Koken', emoji: '🥦',
  ...
  {
    id: 'pan-opwarmen', categorie: 'Bakken', emoji: '🍳',
    naam: 'Pan opwarmen',
    beschrijving: 'Zet de pan op middelhoog vuur en wacht 1–2 minuten. Test: spat een druppel water in de pan — verdampt het direct, dan is de pan goed heet. Voeg pas dan olie of boter toe.',
    afbeelding: 'snippets/pan-opwarmen.jpg'
  },
  {
    id: 'ui-fruiten', categorie: 'Bakken', emoji: '🧅',
    naam: 'Ui fruiten',
  ...
  {
    id: 'vlees-aanbraden', categorie: 'Bakken', emoji: '🥩',
  ...
  {
    id: 'dressing-maken', categorie: 'Bereiden', emoji: '🫙',
  ...
  {
    id: 'deeg-kneden', categorie: 'Bereiden', emoji: '🍞',
    naam: 'Deeg kneden',
  ...
  {
    id: 'handen-wassen', categorie: 'Hygiëne', emoji: '🧼',
    naam: 'Handen wassen',
  ...
  {
    id: 'werkplek-inrichten', categorie: 'Hygiëne', emoji: '🧽',
